 ...
 */
public class MentionsEditText extends androidx.appcompat.widget.AppCompatEditText implements TokenSource {
    ...
    /**
     * Replaces any {@link PlaceholderSpan} within the given text with
    ...
    /**
     * Register a {@link MentionWatcher} in order to receive callbacks
     * when mentions are changed.
     *
     * @param watcher the {@link MentionWatcher} to add
     */
    ...
    /**
     * Remove a {@link MentionWatcher} from receiving anymore callbacks
     * when mentions are changed.
     *
     * @param watcher the {@link MentionWatcher} to remove
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Simple implementation of the {@link MentionWatcher} interface
